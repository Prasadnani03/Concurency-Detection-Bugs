...
<head>
<title>admin_All_severity_category_results</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24">View All Severity Category Results!!!</h2>
...
<iframe width="650" height="650" src="Results.jsp"></iframe>
