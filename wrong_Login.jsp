...
<tr>
<td width="405" height="189" align=center><span class="style3"><font class=sb4>Sorry.</font><BR>
      <BR>
      <font class=sb3>
Your login failed.<BR>
      </font></span>
  <TABLE cellSpacing=0 cellPadding=0 border=0 height="7">
    <TR><TD height=7 class="style3"></TD></TR>
  </TABLE>
  <font class="sb3"><span class="style3">This happens due to - Incorrect Username / Incorrect password<BR>
    </span> </font> 
  <TABLE cellSpacing=0 cellPadding=0 border=0 width="10">
    <TR>
      <TD width="10" height=9 class="style3"></TD></TR>
  </TABLE>
  <font class="sb3"><span class="style3">In case you have forgotten your password,<BR>
    </span> </font> 
  <TABLE cellSpacing=0 cellPadding=0 border=0>
    <TR><TD height=9 class="style3"></TD></TR>
  </TABLE>
  <font class="sb3"><span class="style3">click&nbsp; here to re enter correct&nbsp; username or password on homepage. </span><BR>
  <BR>
  <a href="index.html">Click here to go back</a><BR>
            ...
            <p class="spec"> <a href="#" class="com">11</a></p>
          </div>
          <div class="clr"></div>
        </div>
        <div class="article">
