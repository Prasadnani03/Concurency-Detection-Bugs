...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3">You are Unauthorized  User</span> :<span class="style2"> <%=(String)application.getAttribute("user")%></span>,<br/>
            <span class="style4">Please wait for ADMIN Permission </span></h2>
