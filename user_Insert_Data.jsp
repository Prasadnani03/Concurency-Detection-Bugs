...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">User  Registration Status!!!.</h2>
          
          <div class="clr style7"></div>
        
          
          <p class="style7"><%@ include file="connect.jsp" %>
<%@ page import="java.io.*"%>
...
<%@ page import="com.oreilly.servlet.*"%>
			...
			String paramname=null,uname=null,pass=null,email=null,mno=null,addr=null,dob=null,gender=null,pincode=null,image=null,cloud=null,bin = "",location="",community="";
					...
					if ( rs1.next() )
					   {
					   		%><p class="style5">User name <%=uname%> Already Exists</p>
            <span class="style7">
            <%
            ...
            <p class="style7"><a href="user_Register.jsp">Back</a></p>
				<span class="style7">
				<%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,pincode,status,image,location) values(?,?,?,?,?,?,?,?,?,?,?)");
				...
				<p class="style5">User name <%=uname%> Registered Successfully in Community  <%=community%></p>
				<span class="style7">
				<%
							
			%>			
			    </span>
			<p><span class="style7"><a href="user_Register.jsp">Back</a></span></p>
			<%
